...
import regexpVendor from "eslint-plugin-regexp";
...
function regexp(options = true) {
	return [{
		...typeof options === "boolean" || !options.files ? {} : { files: options.files },
...
//#endregion
//#region node_modules/.pnpm/valibot@1.4.1_typescript@6.0.3/node_modules/valibot/dist/index.mjs
let store$4;
...
const regexpSchema = baseBoolSchema;
...
async function buildConfig(maybeOptions, ...userConfigs) {
	...
	if (vOptions.regexp) configsToCompose.push(regexp(vOptions.regexp));
