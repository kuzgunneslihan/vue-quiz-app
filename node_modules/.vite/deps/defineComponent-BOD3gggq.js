import { Kn as ref, M as Fragment, Qn as toRef, U as computed, Ut as provide, Wn as reactive, Yn as shallowRef, _n as watchEffect, hn as warn, ir as capitalize, nr as unref, nt as defineComponent$1, ut as getCurrentInstance$1, xt as inject } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
...
function getNextElement(elements, location, condition) {
	...
	if (idx < 0) idx = elements.findIndex((el) => el.getAttribute("aria-selected") === "true");
...
function provideDefaults(defaults, options) {
	...
	const newDefaults = computed(() => {
		...
		if (reset || root) {
			...
			const rootDefaults = typeof root === "string" ? properties.prev?.[root] : void 0;
			for (let i = 0; i <= len; i++) {
...
//#endregion
export { omit as A, IN_BROWSER as B, has as C, isPrimitive as D, isObject as E, pickWithRest as F, consoleError as G, SUPPORTS_INTERSECTION as H, refElement as I, propsFactory as J, consoleWarn as K, templateRef as L, padEnd as M, padStart as N, keys as O, pick as P, toKebabCase as R, getPropertyFromItem as S, includes as T, SUPPORTS_MATCH_MEDIA as U, PREFERS_REDUCED_MOTION as V, SUPPORTS_TOUCH as W, flattenFragments as _, provideDefaults as a, getActiveElement as b, getCurrentInstanceName as c, clamp as d, convertToUnit as f, findChildrenWithProvide as g, filterInputAttrs as h, createDefaults as i, onlyDefinedProps as j, mergeDeep as k, EventProp as l, destructComputed as m, genericComponent as n, useDefaults as o, createRange as p, deprecate as q, DefaultsSymbol as r, getCurrentInstance as s, defineComponent as t, chunk as u, focusChild as v, hasEvent as w, getObjectValueByPath as x, focusableChildren as y, wrapInArray as z };
