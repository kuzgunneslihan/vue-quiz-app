...
export async function registerApiResources(server) {
    server.resource('get_api', new ResourceTemplate('vuetify://api@{version}.json', {
        list: async () => {
        ...
        const webtypes = JSON.parse(await cacheApi(version));
