...
export async function registerApiTools(server) {
    server.tool('get_vuetify_api_by_version', 'Download and cache Vuetify API types by version', {
    ...
    server.tool('get_component_api_by_version', 'Return the API list for a Vuetify component', {
        ...
        const api = JSON.parse(await cacheApi(version));
    ...
    server.tool('get_directive_api_by_version', 'Return the API information for a Vuetify directive', {
