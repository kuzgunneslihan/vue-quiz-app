...
export const getSettingsPath = (ide) => {
    switch (ide) {
        case 'code':
        case 'code-insiders': {
...
export function getServerConfig(transport, remote) {
...
export function getClaudeCodeArgs() {
...
export function getClaudeCodeCommand() {
    const args = getClaudeCodeArgs();
    return `claude ${args.map(a => a.includes(':') ? `"${a}"` : a).join(' ')}`;
}
export const getSettingsBuilder = (ide, transport, remote) => {
    if (ide === 'claude-code') {
...
//# sourceMappingURL=settings-builder.js.map