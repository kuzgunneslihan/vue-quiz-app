...
export function createVuetify0Service() {
    return {
        ...
        getComposableGuide: async ({ category, name }) => {
            ...
            if (!categoryData.composables[name]) {
...
//# sourceMappingURL=vuetify0.js.map